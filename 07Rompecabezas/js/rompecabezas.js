/**primero haremos un mapeo sobre las imagenes que se van a 
 * trabajar para el rompecabezas, porque debemos saber donde esta situada
 * cada pieza y a partir de ello compararla con la imagen principal
 * si hacen match ganamos, sino hay que seguir comparando el 
 * orden hasta que coincidan**/
...
//mecesito una funcion para recorrer el arreglo para pazar por cada elemento
...
//creamos funcion para checar si ganamos
...
function mostrarCartelganador(){
    if(checarSiGane()){
        alert("Wiiiiiiii a mimir (o.o)/ ");
    }
    return false;
}

/**vamos a crear una funcion que se encargue de poder intercambiar las 
 * posiviones de las piezas pq dentro del rompecabezas necesitamos mover 
...
/** Ahora viene la parte del movimiento de las piezas, a lo que el hueco
 * es lo que se estara moviendo e intercambiando las posiciones, para ello tenemos
 * que saber que teclas de navegacion se estan presionando y hacia que 
 * direccion debe moverse
 * de ahi el codigo es: arriba 38 abajo 40 izquierda 37 y derecha 39**/
...
function moverEnDireccion(direccion){
    ...
    if(direccion === codigosDireccion.ABAJO){//si y solo si, devuelve true y evalua
    ...
    //tengo que checar si la nueva posicion es valida, sino, intercambiarla
...
function intercambiarPosiciones(fila1, columna1, fila2, columna2){
    ...
    //mando a llamar intercambiar posiciones del rompecabezas
    intercambiarPosicionesRompe(fila1, columna1, fila2, columna2);
    //falta crear funcion cambie posiciones del DOM
...
function mezclarPiezas(veces){
    ...
    //ahora vamos a meter un random las direcciones
